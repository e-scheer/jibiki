...
- ajouter build windows natif, linux et macos
...
- j'aimerai que le site soit encore plus sexy visuellement, qu'on voit le produit et la valeur ajoutée !
- pas de phrase brandy etc, je pense que l'idée c'est d'etre factuelle et fier de ce que ça fait et à mon échelle, je veux pas etre "aguicheur" ou quoi, si vous aimez le produit top sinon c'est rien c'est une niche
