...
class StudyRepository {
  ...
  Future<StudyCard> addCard(ItemType type, String ref) => _store.addCard(type, ref);
  ...
  Future<Map<String, int>> studyStates({ItemType? type}) => _store.states(type: type);
  ...
  Future<StudyQueue> deckQueue(String id, {int? newLimit}) => _store.deckQueue(id, newLimit: newLimit);
  Future<bool> setFavorite(int cardId, bool value) => _store.setFavorite(cardId, value);
}
